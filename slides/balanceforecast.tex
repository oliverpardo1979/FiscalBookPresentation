...
\addplot[blue,thick,dashed,mark=none,restrict x to domain=2023:2035]
    table[col sep=comma,x=year,y=balance_mfmp2024]{datos/escenarios_4_1_4_2.csv};
...
\node[anchor=west,font=\footnotesize,text=blue] at (axis cs:2035.5,0.5) {0,5};
...
{\scriptsize La línea continua muestra los datos hasta 2025. La consolidación comienza en 2028.}
\note{[Sources] Figuras.xlsx, hoja 4.2, B2:R5. MHCP: balance del GNC y MFMP 2024; cálculos propios para los escenarios de actualización y consolidación. El MFMP 2024 proyecta desde 2024. Los datos actualizados hasta 2025 son comunes a los escenarios; las proyecciones comienzan en 2026. Las trayectorias de actualización y consolidación coinciden hasta 2027. En 2035: MFMP 2024, 0,5\% del PIB; actualización, -3,3\%; consolidación, 1,2542\%. Desde 2028, el balance primario de consolidación es 0,2 + 0,1 por la diferencia entre la deuda del año anterior y 55, en puntos del PIB.}
\end{frame}
