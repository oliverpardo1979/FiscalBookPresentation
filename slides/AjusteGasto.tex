\begin{frame}{Salud y Colpensiones elevarían el gasto en 1,9 puntos del PIB}
    ...
    \end{tabular}
    \\[0.35em]
    \scriptsize Niveles en porcentaje del PIB; cambio en puntos del PIB. Los aumentos pueden sumarse porque corresponden a rubros distintos y al mismo período.\\[0.2em]
    \tiny Fuente: Marco Fiscal de Mediano Plazo 2026, gráfs. A.1.5--A.1.6.
    \end{table}
