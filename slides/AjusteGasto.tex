\begin{frame}
    \begin{itemize}
        ...
        \item No obstante, entre 2026 y 2036 el MFMP 2026 proyecta mayores aportes públicos a salud y Colpensiones, parcialmente compensados por una ligera reducción en los regímenes de las Fuerzas Militares y la Policía:
        
        \begin{table}[H]
        \centering
        \caption{Cambio proyectado en aportes de la Nación y las ET, 2026--2036}
        \label{tab:presiones_gasto_2036}
        %\renewcommand{\arraystretch}{1.15}
        \begin{tabular}{l c}
        \hline
        \textbf{Rubro} & \textbf{Variación (pp del PIB)} \\
        \hline
        Salud  & 1,1 \\
        Colpensiones  & 0,8 \\
        Pensiones de FFAA y Policía  & -0,1 \\
        \hline
        Total de los tres rubros & 1,8 \\
        \hline
        \end{tabular}
        \\[0.3em]
        \footnotesize Fuente: MFMP 2026, Apéndice 1, gráficos A.1.5 y A.1.6.
        \end{table}
    \end{itemize}
    \note{[Sources] MFMP 2026, Apéndice 1, gráficos A.1.5 y A.1.6: https://www.minhacienda.gov.co/documents/d/portal/mfmp-2026?download=true. Excel oficial de gráficos y tablas de los apéndices: https://www.minhacienda.gov.co/documents/d/portal/graficas-y-tablas-apendices-mfmp-2026-1?download=true. Variaciones calculadas entre 2026 y 2036: salud 4,5--3,4=1,1 pp; Colpensiones 2,5--1,7=0,8 pp; FFAA 0,7--0,8=-0,1 pp. Consultados el 20 de agosto de 2026.}
\end{frame}
