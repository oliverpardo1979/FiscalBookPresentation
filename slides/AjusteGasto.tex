\begin{frame}
    \begin{itemize}
        ...
        \item Entre 2026 y 2036, el MFMP 2026 proyecta que los aportes públicos a salud y Colpensiones aumenten 1,9 puntos del PIB:
...
\begin{frame}{El CARF estima que el SGP aumentaría 1,4 puntos del PIB}
    \begin{table}[H]
    \centering
    \begin{tabular}{l r r r}
    \hline
    & \textbf{2026} & \textbf{2037} & \textbf{Cambio (pp)} \\
    \hline
    \textbf{SGP (\% del PIB)} & 4,4 & 5,8 & \textbf{+1,4} \\
    \hline
    \end{tabular}
    \end{table}
