...
\begin{frame}{Cómo leer el cuadro: no es una suma}
    \begin{itemize}
        \item \textbf{FF. AA.:} el MFMP 2025 proyecta que las asignaciones de retiro bajen de 0,7\% a 0,6\% del PIB, pero no identifica una reforma que explique la caída. Es un supuesto, no un ahorro asegurado.
