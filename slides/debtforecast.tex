...
\begin{axis}[
    ...
    legend style={at={(0.5,1.035)},anchor=south,legend columns=3,
...
\note{[Sources] Figuras.xlsx, hoja 4.1, B2:R5; supuestos en J7:R9. Inercial corresponde a Actualización en el Excel. MHCP: deuda neta del GNC; cálculos propios para los escenarios inercial y de consolidación. Las proyecciones comienzan en 2026. Desde 2027, deuda/PIB = ((1+r)/(1+g)) por la deuda/PIB del año anterior menos el balance primario del año, con r=5\% y g=3\%. El balance primario proviene de la hoja 4.2. Inercial y consolidación coinciden hasta 2027. En 2035: inercial, 107,5794\%; consolidación, 65,5608\%. Ancla: 55\%; límite: 71\%, referencias conservadas de la figura anterior.}
\end{frame}
