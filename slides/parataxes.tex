\begin{frame}{Aportes a seguridad social y parafiscales como \% del IBC según tipo de trabajador (Dependiente o Independiente)}
\begin{table}[h!]
\centering
...
\end{tabular}
\vspace{0.1cm} 
\par \footnotesize{\textit{Fuente: Elaboración propia con la colaboración de Mauricio Salazar}}
\end{table}
\end{frame}
